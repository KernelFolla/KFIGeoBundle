...
-- Dumping structure for table comodo2_dev.geo_region
...
-- Dumping data for table comodo2_dev.geo_region: ~20 rows (approximately)
/*!40000 ALTER TABLE `geo_region` DISABLE KEYS */;
INSERT IGNORE INTO `geo_region` (`id`, `code`, `name`, `zone`, `latitude`, `longitude`, `deleted`, `country_id`) VALUES
